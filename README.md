...
Three series from the journal *GENETICS* are tagged, and the first two are cross-referenced:
...
- **`GeneticsClassic`** — the 2016 GSA-centennial **"Classics"** series: a commentary revisiting one specific landmark paper, without discussion questions. Titles take the form *"&lt;Commentator&gt; on &lt;Topic&gt;"* (e.g. Nielsen on Tajima 1983). 12 notes.
- **`GeneticsPerspectives`** — the **"Perspectives: Anecdotal, Historical and Critical Commentaries on Genetics"** series (edited by James F. Crow and William F. Dove, 1987–). Historical, biographical and retrospective essays about a person, an era or a topic rather than about a single paper — "Max Delbrück", "The Year of the Fly", "Hogness at one hundred". 57 notes.

Classics and Perspectives are separate series and are easy to confuse; membership is decided from the section label on the article's first page, preserved in `extract/`.
...
| `Allison2004_Genetics_GeneticsMedicine-TwoLessons` | Two Lessons From the Interface of Genetics and Medicine | Genetics Perspectives |
...
| `Baker2009_Genetics-Perspective-FlyLeg` | Drosophila Leg Proximodistal Patterning: From Polar Coordinate Model to Boundary Model (Baker 2011) | Genetics Perspectives |
...
| `Brenner2009_Genetics_Celegans` | In the Beginning Was the Worm . . . | Genetics Perspectives |
...
| `Charlesworth2009_Genetics_Perspective-DarwinGenetics` | Darwin and Genetics | Genetics Perspectives |
...
| `Crow1987_Genetics_Kimura-MolecularEvolution` | Twenty-Five Years Ago in Genetics: Motoo Kimura and Molecular Evolution | Genetics Perspectives |
| `Crow1988_Genetics_PopulationGenetics-Beginnings` | Eighty Years Ago: The Beginnings of Population Genetics | Genetics Perspectives |
| `Crow1990_Genetics_Fisher-CentennialView` | R. A. Fisher, a Centennial View | Genetics Perspectives |
| `Crow1997_Genetics_Mutation-BecomesExperimental` | Seventy Years Ago: Mutation Becomes Experimental | Genetics Perspectives |
| `Crow2006_Genetics_Muller+CompetitionHoax` | H. J. Muller and the "Competition Hoax" | Genetics Perspectives |
...
| `Denell1994_Genetics_AntennapediaComplex` | Discovery and Genetic Definition of the Drosophila Antennapedia Complex | Genetics Perspectives |
...
| `Dove1987_Genetics_MouseMolecularGenetics` | Molecular Genetics of *Mus musculus*: Point Mutagenesis and Millimorgans | Genetics Perspectives |
| `Dove1988_Genetics_YearOfTheFly` | The Year of the Fly | Genetics Perspectives |
| `Dove2016_Genetics_PerspectivesSeries-Tapestry` | Weaving a Tapestry from Threads Spun by Geneticists: The Series Perspectives on Genetics, 1987–2008 | Genetics Perspectives |
| `Dugatkin2007_Genetics_InclusiveFitness-DarwinHamilton` | Inclusive Fitness Theory from Darwin to Hamilton | Genetics Perspectives |
...
| `Edwards2007_Genetics_Fisher-RhesusBloodGroup` | R. A. Fisher's 1943 Unravelling of the Rhesus Blood-Group System | Genetics Perspectives |
| `Edwards2008_Genetics_HWE` | G. H. Hardy (1908) and Hardy–Weinberg Equilibrium | Genetics Perspectives |
| `Edwards2009_Genetics_Perspectives-EvolutionaryTreeStatistics` | Statistical Methods for Evolutionary Trees | Genetics Perspectives |
| `Emdin2017_JAMA_MendelianRandomization` | Mendelian Randomization |  |
| `Fairbank2016_Genetics_Darwin+Mendel` | Darwin's Influence on Mendel: Evidence from a New Translation of Mendel's Paper | Genetics Perspectives |
| `Falk1993_Genetics_Morgan-GeneticControlDevelopment` | Morgan's Hypothesis of the Genetic Control of Development | Genetics Perspectives |
| `Falk2010_Genetics_Mutagenesis-ResearchStrategy` | Mutagenesis as a Genetic Research Strategy | Genetics Perspectives |
| `Feschotte2026_NatRevGenet_TransposableElements-Innovation` | Transposable elements as catalysts of evolutionary innovation |  |
| `Fischer2007_Genetics_MaxDelbruck` | Max Delbrück | Genetics Perspectives |
...
| `Garen1992_Genetics_Homunculus` | Looking for the Homunculus in Drosophila | Genetics Perspectives |
...
| `Gould2009_Genetics_ComparativeGenetics-BreastCancer` | The Utility of Comparative Genetics to Inform Breast Cancer Prevention Strategies | Genetics Perspectives |
...
| `Green2010_Genetics_WhiteGene-DrosophilaCentury` | 2010: A century of Drosophila genetics through the prism of the white gene | Genetics Perspectives |
| `Griffing1991_Genetics_Arabidopsis-GeneticStudies` | Qualitative and Quantitative Genetic Studies of Arabidopsis thaliana | Genetics Perspectives |
...
| `Hawley1993_Genetics_MeioticMutants-Drosophila` | Meiosis as an "M" Thing: Twenty-Five Years of Meiotic Mutants in Drosophila | Genetics Perspectives |
...
| `Hobert2010_Genetics_WholeGenomeSequencing` | The Impact of Whole Genome Sequencing on Model System Genetics: Get Ready for the Ride | Genetics Perspectives |
| `Horowitz1991_Genetics_Neurospora-Revolution` | Fifty Years Ago: The Neurospora Revolution | Genetics Perspectives |
| `Horowitz1996_Genetics_BiochemGenetics` | The Sixtieth Anniversary of Biochemical Genetics | Genetics Perspectives |
...
| `Keightley1996_Genetics_Dominance-Recessivity` | A Metabolic Basis for Dominance and Recessivity | Genetics Perspectives |
| `Kerfeld2011_PLoSBiol_BLAST` | Using BLAST to Teach "E-value-tionary" Concepts |  |
| `Kingsley2025_Genetics_Hogness-Centennial` | Hogness at one hundred | Genetics Perspectives |
...
| `Laurie1997_Genetics_Haldane+Heterogametic` | The Weaker Sex Is Heterogametic: 75 Years of HALDANE'S Rule | Genetics Perspectives |
| `Lederberg1987_Genetics_EcoliRecombination` | Gene recombination and linked segregations in Escherichia coli | Genetics Perspectives |
...
| `Miller1997_Genetics_ChromosomeChangesCellDivision` | Chromosome Changes in Cell Differentiation | Genetics Perspectives |
...
| `Morton1995_Genetics_LODs` | LODs Past and Present | Genetics Perspectives |
...
| `Nogler2006_Genetics_Perspective-MendelHieracium` | The Lesser-Known Mendel: His Experiments on Hieracium | Genetics Perspectives |
...
| `Orr1996_Genetics_Dobzhansky-Bateson-Speciation` | Dobzhansky, Bateson, and the Genetics of Speciation | Genetics Perspectives |
| `Orr2009_Genetics_Darwin-SocialImplications` | Darwin and Darwinism: The (Alleged) Social Implications of The Origin of Species | Genetics Perspectives |
| `Paigen2010_NatRevGenet_RecombinationHotspots-Mammals` | Mammalian recombination hot spots: properties, control and evolution |  |
| `Parkinson1987_Genetics_BehavioralGenetics-Bacteria` | Doing Behavioral Genetics with Bacteria | Genetics Perspectives |
...
| `Perkins1992_Genetics_Neurospora-Organism` | Neurospora: The Organism Behind the Molecular Revolution | Genetics Perspectives |
...
| `Powell1987_Genetics_Dobzhansky-GeneticsAndTheOriginOfSpecies` | "In the Air" — Theodosius Dobzhansky's Genetics and the Origin of Species | Genetics Perspectives |
| `Preer1997_Genetics_ParameciumGenetics` | Whatever Happened to *Paramecium* Genetics? | Genetics Perspectives |
...
| `Provine1991_Genetics_Sturtevant-Drosophila` | Alfred Henry Sturtevant and crosses between Drosophila melanogaster and Drosophila simulans | Genetics Perspectives |
| `Provine2004_Genetics_ErnstMayr-Speciation` | Ernst Mayr: Genetics and Speciation | Genetics Perspectives |
...
| `Sarkar1991_Genetics_LuriaDelbruck+Haldane` | Haldane's Solution of the Luria-Delbrück Distribution | Genetics Perspectives |
| `Sarkar1996_Genetics_LancelotHogben` | Lancelot Hogben, 1895–1975 | Genetics Perspectives |
...
| `Shapiro2009_Genetics_Perspective-Ecoli-GenomeEng` | Shapiro 2009 — Natural Genetic Engineering: Retrospective on E. coli Genome Engineering | Genetics Perspectives |
...
| `Smithies1995_Genetics_GelElectrophoresis` | Early days of gel electrophoresis | Genetics Perspectives |
...
| `Spradling2006_Genetics_LearningGenetics` | Spradling 2006 — Learning the Common Language of Genetics | Genetics Perspectives |
| `Sreenivasan2025_NatRevGenet_StructuralVariants-3DGenome` | Structural variants in the 3D genome as drivers of disease |  |
| `Stahl1992_Genetics_UnicornsRevisited` | Unicorns Revisited | Genetics Perspectives |
| `Stahl1995_Genetics_AmberMutants-PhageT4` | The Amber Mutants of Phage T4 | Genetics Perspectives |
| `Stearns2010_Genetics_Perspective-Pleiotropy` | Stearns 2010 — One Hundred Years of Pleiotropy: A Retrospective | Genetics Perspectives |
...
| `Takahata2007_Genetics_MolecularClock` | Molecular clock: an anti-neo-Darwinian legacy | Genetics Perspectives |
...
| `Uller2018_Genetics_DevelopmentalBias` | Uller et al. 2018 — Developmental Bias and Evolution: A Regulatory Network Perspective | Genetics Perspectives |
...
| `Wilkins2009_Genetics_MeiosisFromMitosis` | Wilkins & Holliday 2009 — The Evolution of Meiosis From Mitosis | Genetics Perspectives |
...
| `Yanofsky2005_Genetics_TryptophanSynthase-OneGeneOneEnzyme` | The Favorable Features of Tryptophan Synthase for Proving Beadle and Tatum's One Gene–One Enzyme Hypothesis | Genetics Perspectives |
| `Zhang2025_NatRevGenet_SynonymousMutations` | Functional synonymous mutations and their evolutionary consequences |  |
| `Zinder1992_Genetics_BacterialTransduction` | Forty Years Ago: The Discovery of Bacterial Transduction | Genetics Perspectives |
