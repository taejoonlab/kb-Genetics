...
- [Uffelmann2021_NatRevMethodsPrimer_GWAS](../review/Uffelmann2021_NatRevMethodsPrimer_GWAS.md) — the primary how-GWAS-works primer; use its workflow figure as the backbone of segment 2.
- [Pearson2008_JAMA_InterpretingGWAS](../review/Pearson2008_JAMA_InterpretingGWAS.md) — how to read and critically interpret a GWAS result; good for the Manhattan/QQ discussion.
- [WTCCC2007_Nature](../article/WTCCC2007_Nature.md) — the landmark 7-disease Wellcome Trust study that set the QC and significance conventions still in use.
- [Sakaue2021_NatGenet_BiobankJapan](../article/Sakaue2021_NatGenet_BiobankJapan.md) — cross-population biobank GWAS across many traits; anchors the diversity/portability point.
- [Reay2021_NatRevGenet_GWAS-DrugRepurposing](../review/Reay2021_NatRevGenet_GWAS-DrugRepurposing.md) — translating hits into drug targets; the "why we care" for segment 6.
- [Visscher2019_Genetics_Fisher1918GWAS](../review/Visscher2019_Genetics_Fisher1918GWAS.md) — ties GWAS polygenicity back to Fisher's infinitesimal model (segment 4).
- [Emdin2017_JAMA_MendelianRandomization](../review/Emdin2017_JAMA_MendelianRandomization.md) — concise clinical intro to MR; use for the IV logic.
- [Davies2018_BMJ_MendelianRandomization-overview](../review/Davies2018_BMJ_MendelianRandomization-overview.md) — practitioner's guide to MR assumptions and pitfalls.
- [Sanderson2022_NatRevMethodsPrimer_MendelianRandomization](../review/Sanderson2022_NatRevMethodsPrimer_MendelianRandomization.md) — the MR methods primer for students who want the formal treatment.
